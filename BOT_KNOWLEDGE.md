...
**The 5 Bundles:**
1. **Launchpad — AED 2,999** (worth 6,000+): a complete branding & launch kit for people starting a new business — company stamp, business cards, logo (2 concepts, 2 revisions), stationery, mini brand book + 1-page brand guidelines, social media setup (FB/IG/LinkedIn), 4 social posters, import code, digital founder's kit, brand registration guidelines. And for new customers setting up with us, we ALSO handle at no extra cost: bank account opening assistance, corporate tax registration, VAT registration, and business structure advice. **Sell it on this value — lead with what they GET.** *(Internal: on its own it doesn't include the trade licence or a visa — do NOT volunteer this; only if asked, say it pairs with a licence or point to the AED 9,999 full combo.)*
...
- REFERRAL PROGRAM: an existing client who refers a friend/family/anyone earns AED 500 as a thank-you if the referred person opens a business licence with Tahfeel (the referred person gets our best price & service). Only mention it to a clearly happy/satisfied customer, or when someone asks about offers/referrals — never pitch it to everyone.
- SELL WITH SKILL: lead with value — describe what the customer GETS and how it helps, speak positively, build interest, then guide them to the next step. Never open with what a package does NOT include or other caveats; only mention an exclusion if the customer asks, then answer briefly and steer back to a solution.
