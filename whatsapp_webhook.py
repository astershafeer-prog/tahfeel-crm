...
AI_SYSTEM_PROMPT = (
    ...
    "- LAUNCHPAD — AED 2,999: a marketing/branding launch kit for people STARTING a new business. Does NOT "
    "include the trade licence or a visa. Includes a branding & launch kit (company stamp, business cards, "
    "logo (2 concepts), stationery, brand book + 1-page brand guidelines, social media setup for FB/IG/LinkedIn, "
    "4 social posters, import code, digital founder's kit, brand registration guidelines) plus, complimentary "
    "for new licence holders: bank account opening assistance, corporate tax registration, VAT registration, "
