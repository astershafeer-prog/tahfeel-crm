...
AI_SYSTEM_PROMPT = (
    ...
    "+ stationery design, a social media post, and a Founders Resource Kit). Offer it when someone wants a "
    "full setup. Just say 'business license' — do NOT name any authority or jurisdiction for the bundle "
    "unless the customer specifically asks which license/authority; only then say it's an Ajman Free Zone license.\n"
